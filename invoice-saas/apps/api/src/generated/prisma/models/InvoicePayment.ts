...
export type InvoicePaymentMinAggregateOutputType = {
  ...
  amount: runtime.Decimal | null
  method: $Enums.InvoicePaymentMethod | null
...
export type InvoicePaymentGroupByOutputType = {
  ...
  method: $Enums.InvoicePaymentMethod
  reference: string | null
  paidAt: Date
  createdAt: Date
  updatedAt: Date
...
export type InvoicePaymentWhereInput = {
  ...
  amount?: Prisma.DecimalFilter<"InvoicePayment"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  method?: Prisma.EnumInvoicePaymentMethodFilter<"InvoicePayment"> | $Enums.InvoicePaymentMethod
  reference?: Prisma.StringNullableFilter<"InvoicePayment"> | string | null
...
export type InvoicePaymentScalarWhereWithAggregatesInput = {
  ...
  amount?: Prisma.DecimalWithAggregatesFilter<"InvoicePayment"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  method?: Prisma.EnumInvoicePaymentMethodWithAggregatesFilter<"InvoicePayment"> | $Enums.InvoicePaymentMethod
  reference?: Prisma.StringNullableWithAggregatesFilter<"InvoicePayment"> | string | null
...
export type InvoicePaymentUpdateInput = {
  ...
  method?: Prisma.EnumInvoicePaymentMethodFieldUpdateOperationsInput | $Enums.InvoicePaymentMethod
...
export type EnumInvoicePaymentMethodFieldUpdateOperationsInput = {
  set?: $Enums.InvoicePaymentMethod
}
...
export type InvoicePaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "invoiceId" | "amount" | "method" | "reference" | "paidAt" | "createdAt" | "updatedAt", ExtArgs["result"]["invoicePayment"]>
...
export interface InvoicePaymentFieldRefs {
  ...
  readonly amount: Prisma.FieldRef<"InvoicePayment", 'Decimal'>
  readonly method: Prisma.FieldRef<"InvoicePayment", 'InvoicePaymentMethod'>
